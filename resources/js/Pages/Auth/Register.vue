    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <button
                        ...
                        :class="form.role === 'farmer'
                            ...
                            : 'border-gray-200 dark:border-white/10 text-gray-500 dark:text-gray-400 hover:border-emerald-300 hover:bg-gray-50 dark:hover:bg-white/5 dark:bg-white/5 dark:hover:bg-white/5 dark:bg-white/5'"
                    >
                    ...
                    <button
                        ...
                        :class="form.role === 'buyer'
                            ...
                            : 'border-gray-200 dark:border-white/10 text-gray-500 dark:text-gray-400 hover:border-amber-300 hover:bg-gray-50 dark:hover:bg-white/5 dark:bg-white/5 dark:hover:bg-white/5 dark:bg-white/5'"
                    >
            ...
            <div class="mt-6 flex items-center justify-between">
                <Link
                    :href="route('login')"
                    class="rounded-md text-sm text-gray-600 hover:text-gray-900 dark:text-white transition-colors"
                >
                    Sudah punya akun?
                </Link>
